...
namespace Gemmob.Common.Data {
	public static class UserEncryption {
		...
		private static void SetupProvider() {
			...
			var substring = identifier.Substring(0, Math.Min(identifier.Length - 1, 32));
			var key = substring.PadRight(32, '@');
			Logs.LogFormat("User Encrypt key: {0}", key);
		...
		/** <summary> Encrypts the specified string using the key stored in SimpleEncryption and returns the encrypted result </summary> */
